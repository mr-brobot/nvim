...
- `make` and a C compiler (`gcc` or `clang`) — builds [`telescope-fzf-native`](https://github.com/nvim-telescope/telescope-fzf-native.nvim) and compiles Treesitter grammars
